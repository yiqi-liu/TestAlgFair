...
for (rep in 1:20){
  ...
  # estimate the nuisance parameters using logit lasso
  est_nuisance <- nuisance(X=X, G=G, Y=Y, method="lasso-logit")
  ...
  write.csv(data.frame(cbind(estR1, estR2, estB1, estB2, estF,
            ...
            file="../../results/rep-results/rep-lasso.csv", row.names = F)
