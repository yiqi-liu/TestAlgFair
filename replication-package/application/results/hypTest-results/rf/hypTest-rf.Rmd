...
# estimate the nuisance parameters using random forests (5000 trees)
est_nuisance <- nuisance(X=X, G=G, Y=Y, 
                         method = "grf", seed=0, num.trees=5000)
...
grid.arrange(
  ...
  ncol = 2,
  widths = c(3, 0.5),
  top = textGrob(TeX("Estimated feasible set ($\\theta$ estimated by random forests)"), 
